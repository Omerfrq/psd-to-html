...
const OptionHeader = ({ children }) => {
  return (
    <Row className='mx-0 mb-3 px-3 py-2 bg-yellow justify-content-between align-items-center'>
      <h5 className='mb-0 font-weight-bold text-capitalize'>List 2 Options</h5>
      <div className='d-flex align-items-center'>
        <div className='text-center'>
          <h5 className='font-weight-bold'>Select Item(s) from List 2</h5>
          <h6 className='mb-0 text-danger font-weight-bold text-capitalize'>
            0 items selected
          </h6>
        </div>
        <Button variant='success' className='ml-4 p-3 border-0 text-white'>
          {children}
        </Button>
      </div>
