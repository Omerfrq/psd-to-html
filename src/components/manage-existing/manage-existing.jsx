...
const ManageExisting = ({ showManageExisting, onHide, onSubmit }) => {
  return (
    <Collapse in={showManageExisting}>
      <Form className='p-3' onSubmit={onSubmit}>
            ...
            <tr>
              <th className='position-relative'>
                ...
                <span className='pos-top d-flex flex-column'>
                  ...
                  >
                    <h6 className='mb-0 text-muted'>&times;</h6>
                  </Button>
                  <Button variant='warning' size='sm' className='align-top p-0'>
                    <small className='mb-0 text-muted'>▼</small>
                  </Button>
                </span>
              </th>
              <th className='position-relative'>
        ...
        <Form.Row className='w-100 align-items-center mx-0'>
          ...
          <Col className='my-1 mx-auto d-flex'>
            <Pagination className='mx-auto w-50 justify-content-around align-items-center'>
              <Pagination.Prev />
